<script>
    ...
    // Handle Initial Load
    onMount(() => {
        // Keep visible for a moment to show animation, then fade out
        setTimeout(() => {
            initialLoad = false;
        }, 1200);
    });
...
<style>
    .page-loader {
        ...
        pointer-events: none; /* Let clicks pass through during fade out? No, block while visible */
        pointer-events: auto;
    }
    ...
    .logo-path {
        ...
        animation: logoLoaderLoop 2s ease-in-out infinite alternate;
    }

    /* Fast, seamless loop */
    @keyframes logoLoaderLoop {
