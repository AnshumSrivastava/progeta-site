    ...
    <div class="container" style="text-align: center;">
        <div use:reveal>
            ...
            <p class="page-subtitle">
                Select a specialized diploma program to view the full deployment
                curriculum. Each track simulates a real-world cybersecurity
                role.
            </p>
        </div>
    </div>
