...
<div class="store-container">
    {#if game}
        ...
        <div
            class="game-hero"
            style="background-image: url({getImgUrl(game.coverImage)});"
        >
            <div class="hero-gradient"></div>
            <div class="hero-content">
                <a href="{base}/games" class="back-link">&larr; Library</a>
                <h1>{game.title}</h1>
            </div>
        </div>
                        ...
                        <div class="media-grid">
                            {#if game.screenshots && game.screenshots.length > 0}
                                {#each game.screenshots as screen, i}
                                    <img
                                        src={getImgUrl(screen)}
                                        alt="Gameplay Screen {i + 1}"
                                        class="screenshot"
                                    />
                                {/each}
                            {:else}
                ...
                <div class="info-block">
                    ...
                    {#if game.learnedSkills}
                        <div class="reqs">
                            ...
                            <ul
                                style="list-style: none; padding: 0; margin: 0; color: #aaa; font-size: 0.85rem;"
                            >
